...
ANGLE_CONFIGS = [
    ...
    AngleConfig("02-全身左侧面", horizontal_angle=90, vertical_angle=0, distance=2,
                prompt="full body left side view, showing left side of body, white background, consistent lighting"),
    AngleConfig("03-全身右侧面", horizontal_angle=270, vertical_angle=0, distance=2,
                prompt="full body right side view, showing right side of body, white background, consistent lighting"),
    ...
    AngleConfig("05-面部特写左侧", horizontal_angle=90, vertical_angle=0, distance=0,
                prompt="face close-up showing left side of face, left profile view, face turned right, white background, consistent lighting"),
    ...
    AngleConfig("08-面部特写右侧", horizontal_angle=270, vertical_angle=0, distance=0,
                prompt="face close-up showing right side of face, right profile view, face turned left, white background, consistent lighting"),
    
    # Row 3: Half body 45-degree and side views
    AngleConfig("09-半身左侧45度", horizontal_angle=45, vertical_angle=0, distance=1,
                prompt="half body three-quarter view showing left side, white background, consistent lighting"),
    AngleConfig("10-半身左侧面", horizontal_angle=90, vertical_angle=0, distance=1,
                prompt="half body left side view, showing left side of body, white background, consistent lighting"),
    AngleConfig("11-半身右侧面", horizontal_angle=270, vertical_angle=0, distance=1,
                prompt="half body right side view, showing right side of body, white background, consistent lighting"),
    AngleConfig("12-半身右侧45度", horizontal_angle=315, vertical_angle=0, distance=1,
                prompt="half body three-quarter view showing right side, white background, consistent lighting"),
